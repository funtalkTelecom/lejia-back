...
<%@page import="com.lejia.global.CookieHandle" %>
<!DOCTYPE html>
<head>
    <title>乐家商城</title>
...
<body class="login-layout" style="background:url(<%=basePath %>project/images/login-b.jpg) no-repeat center;background-size:auto auto;"common>
