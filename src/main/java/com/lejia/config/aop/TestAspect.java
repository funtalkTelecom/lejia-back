...
public class TestAspect {
    ...
    @Pointcut(value="@annotation(com.lejia.config.annotation.NoRepeat)")
//    @Pointcut(value="execution(* com.lejia.service.*.pay*(..))")
     ...
     * @param joinPoint
     */
    //    @After(value="value="execution(* com.lejia.service.*.pay*(..))")
...
//     * @param joinPoint
//     */
//    @Before(value="execution(* com.lejia.service.*.pay*(..))")
