...
import com.lejia.config.interceptors.APIInterceptor;
import com.lejia.config.interceptors.PowerInterceptor;
...
public class ApplicationConfig extends WebMvcConfigurerAdapter{
    ...
    public void addInterceptors(InterceptorRegistry registry) {
    	InterceptorRegistration ir=registry.addInterceptor(powerInterceptor)
                                           .addPathPatterns("/**")
                                           .excludePathPatterns("/api/**");//拦截
